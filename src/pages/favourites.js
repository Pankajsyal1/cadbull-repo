        ...
        <div className="container">
          <div className="row mb-4">
            <div className="col-md-12">
              <PageHeading title={"Favourites"} description={"Choose from 254195+ Free & Premium CAD Files with new additions published every second month "} />
            </div>
          </div>
          {/* Table  */}
                          ...
                          <tr key={res.id}>
                            ...
                            <td>
                              <div className="d-inline-flex gap-2">
                                <button type="button" className="btn btn-success"><Icons.Download /></button>
                                <button type="button" className="btn btn-danger-variant"><Icons.Delete /></button>
                              </div>
                            </td>
                          </tr>
                        )
