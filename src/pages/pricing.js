      ...
      <div className="container">
        <div className="row justify-content-center">
          ...
          <div className="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-5">
            <div className="switch-wraper d-flex gap-2 justify-content-start justify-content-sm-center align-items-center mb-3 mb-md-4 position-relative" data-aos="flip-up"
              data-aos-anchor-placement="bottom-bottom" data-aos-easing="linear"
              data-aos-duration="500">
              <p className="text-primary fw-semibold">Pay Monthly</p>
              <div class="form-check form-switch mb-0 py-0" style={{ minHeight: "unset" }}>
          ...
          <div className="col-sm-11 col-md-10 col-lg-9 col-xl-8">
            <div className="pricing-slider text-start mb-5" data-aos="flip-up"
              data-aos-anchor-placement="bottom-up" data-aos-easing="linear"
              data-aos-duration="500">
      ...
      <div className="container py-md-5">
        <div className="row gy-4 align-items-center">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="pricing-card" data-aos="flip-left"
              data-aos-anchor-placement="bottom-bottom" data-aos-easing="linear"
              data-aos-duration="500">
              <div className="h-100 inner-wrapper" style={{ borderTopColor: '#1D1D5' }}>
                ...
                <div>
                  <button type="button" className="btn btn-primary">GET STARTED WEEKLY</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="pricing-card">
              ...
              <div className="h-100 inner-wrapper py-5" style={{ borderTopColor: '#4A4A4A', background: '#4A4A4A' }}>
                ...
                <div className="pb-5">
                  <button type="button" className="btn btn-light">GET STARTED MONTHLY</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="pricing-card" data-aos="flip-left"
              ...
              <div className="h-100 inner-wrapper" style={{ borderTopColor: '#3D6098' }}>
                ...
                <div>
                  <button type="button" className="btn btn-primary">GET STARTED ANNUAL</button>
                </div>
              </div>
            </div>
          </div>
