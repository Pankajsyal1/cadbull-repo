                          ...
                          <tr key={res.id}>
                            ...
                            <td>
                              <div className="d-inline-flex gap-2">
                                <button type="button" className="btn btn-success text-white"><Icons.Download/></button>
                                <button type="button" className="btn btn-danger-variant bg-danger border-danger text-white"><Icons.Delete/></button>
                              </div>
                            </td>
                          </tr>
                        )
