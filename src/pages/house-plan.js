...
const HousePlan = () => {
  return (
    <Fragment>
      ...
      <CategoriesLayout title={"Architecture House Plan CAD Drawings CAD Blocks & 21354 Files"} description={"Cadbull presents variety of online drawing including DWG drawing, Cad drawing, AutoCAD drawing, 3D Drawing. Wide range of 3D Drawing, DWG drawing, Cad drawing, AutoCAD drawing available as per your need."} categories={categories} type={"Categories"} pageName="House Plan">
        <section>
