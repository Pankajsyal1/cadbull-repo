        ...
        <div className="container">
          ...
          <div className="row mb-4 gy-3 ">
            <div className="col-md-2">
                <div className="profile-image-wrapper d-flex gap-2" data-aos="flip-up"
          ...
          <div className="row py-3 py-md-4">
            <div className="col-md-12">
              <div className="d-flex justify-content-between gap-4 gap-md-2 flex flex-column flex-md-row">
                <div class="nav nav-pills flex-nowrap" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <button class="nav-link active" id="v-pills-image-tab" data-bs-toggle="pill" data-bs-target="#v-pills-image" type="button" role="tab" aria-controls="v-pills-image" aria-selected="true">Image (500)</button>
                  <button class="nav-link" id="v-pills-cad-tab" data-bs-toggle="pill" data-bs-target="#v-pills-cad" type="button" role="tab" aria-controls="v-pills-cad" aria-selected="false">CAD File (360)</button>
                </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-image" role="tabpanel" aria-labelledby="v-pills-image-tab" tabindex="0">
                          ...
                          <div className="col-lg-4 col-sm-6" key={project.id}>
                            <div className='project-day-card h-100' data-aos="flip-left"
                              ...
                              <div className='project-day-card-image mb-3 position-relative'>
                                <img src={project.image.src} alt="project" className='drawing-image w-100 img-fluid' />
                                <div className='z-1 action-buttons-wrapper position-absolute bottom-0 end-0 d-inline-flex flex-column gap2 pe-2 pb-2'>
                ...
                <div class="tab-pane fade" id="v-pills-cad" role="tabpanel" aria-labelledby="v-pills-cad-tab" tabindex="0">
                  <div className="row g-4">
                    {
                      projects.map((project) => {
                        return (
