    ...
    <Fragment>
      ...
      <section className="py-md-5 py-3 company-page">
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="mb-3 mb-md-4" data-aos="flip-up"
              ...
              <div className="row mb-3 mb-md-4 gy-4 gy-md-3">
                ...
                <div className="col-xl-3 col-lg-5 col-md-6">
                  <div className="d-flex flex-column gap-3">
                    {/* 1  */}
                    <div className="d-flex gap-2 align-items-center mb-1" data-aos="flip-up"
                      data-aos-anchor-placement="bottom-bottom" data-aos-easing="linear"
                      data-aos-duration="500">
                    ...
                    <div className="d-flex gap-1 align-items-start">
                      ...
                      <div>
                        ...
                        <div className="row row-cols-2 gy-4 mt-3">
                          {/* 2.1  */}
                          <div className="border-start border-danger border-3" data-aos="flip-up"
                            data-aos-anchor-placement="bottom-bottom" data-aos-easing="linear"
                            data-aos-duration="500">
        ...
        <div className="container">
          ...
          <div className="row gy-4">
            <div className="col-md-6">
              <div className="h-100" data-aos="flip-up"
                data-aos-anchor-placement="bottom-bottom" data-aos-easing="linear"
                data-aos-duration="500">
            ...
            <div className="col-md-6">
              <div className="p-md-4 p-3 rounded-3 w-100 border border-secondary h-100 d-flex align-items-start align-items-center justify-content-lg-between gap-3" data-aos="flip-up"
